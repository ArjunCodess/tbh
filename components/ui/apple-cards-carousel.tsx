    ...
    <>
        ...
        {open && (
          <div className="fixed inset-0 h-screen z-50 overflow-auto">
            ...
            <motion.div
              ...
              className="max-w-5xl mx-2 md:mx-auto bg-white dark:bg-neutral-900 h-fit  z-[60] my-10 md:my-4 p-4 md:p-10 rounded-3xl relative"
            >
              <button
      ...
      >
        ...
        <BlurImage
          ...
          alt={card.title}
          fill
          className="object-contain bg-black absolute z-10 inset-0"
        />
      </motion.button>
    </>
  );
